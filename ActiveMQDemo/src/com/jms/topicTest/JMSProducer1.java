...
public class JMSProducer1 {
    ...
    private static final String BROKEURL = "tcp://172.17.70.49:61616";//默认连接地址  failover//
    //发送的消息数量
    ...
    public static void main(String[] args) {
        ...
        //实例化连接工厂
        connectionFactory = new ActiveMQConnectionFactory(JMSProducer1.USERNAME, JMSProducer1.PASSWORD, JMSProducer1.BROKEURL);
